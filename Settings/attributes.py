...
xROBOT_TURN_RADIUS = 40 * SCALING_FACTOR
yROBOT_TURN_RADIUS = 30 * SCALING_FACTOR
TURN_RADIUS = 40 * SCALING_FACTOR
ROBOT_SPEED_PER_SECOND = 30 * SCALING_FACTOR
ROBOT_S_FACTOR = ROBOT_LENGTH / TURN_RADIUS  
...
PATH_TURN_COST = 999 * ROBOT_SPEED_PER_SECOND * TURN_RADIUS
