...
from bullseye_robot.bullseye_commands import *
...
class Robot:
    ...
    def convert_commands(self):
        ...
        index_list = [index + 1 for index, value in enumerate(string_commands) if value.startswith("S")]
